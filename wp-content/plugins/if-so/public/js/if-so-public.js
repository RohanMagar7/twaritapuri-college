...
ifso_scope.DispatchTriggersLoaded = function() {
    document.dispatchEvent(ajax_triggers_loaded);
};
    ...
    $(document).ready(function() {
        ...
        if_so_public.prototype = {
            ...
            ifso_analytics_do_conversion: function(allowed, disallowed) {
                ...
                var params = {
                    an_action: 'doConversion',
                    postid: 666,
                    data: JSON.stringify(ifso_viewed_triggers)
                };
        ...
        if (isAnalyticsOn) { //Passed from if-so public
            ...
            if (ifso_public_instance.getCookie('ifso_viewing_triggers')) ifso_public_instance.sendAjaxReq('ifso_analytics_req', {
                postid: 666,
                an_action: 'ajaxViews',
                data: ifso_public_instance.getCookie('ifso_viewing_triggers')
            });
