...
(function($) {
    ...
    $.fn.ggPrettyPhoto = function(pp_settings) {
        ...
        pp_settings = jQuery.extend({
            ...
            /* used in _fitToViewportImage wrapper to get proper dimensions on images*/
            ie6_fallback: true,
            'is_lazy_load': 0,
            markup: markupHtml,
        ...
        var matchedObjects = this,
            ...
            , pp_contentHeight, pp_contentWidth, pp_attributesWidth = (pp_settings.isShowAttributes ? parseFloat(pp_settings.attributesWidth) : 0),
            pp_containerHeight, pp_containerWidth
            // Window size
                    ...
                    $pp_pic_holder.animate({
                        ...
                        if (settings.isShowRotateBtn && window.prettyPhotoShowContent) {
                            window.prettyPhotoShowContent(
                                changeWidthAndHeight, currImgRotateVal, $ppPopupImage, $ppImageWrapper, pp_dimensions
                            );
                        }
