(function($, undefined) {
    ...
    Gallery.prototype.initPagination = (function() {
        ...
        var showCurrentPage = (function(gallery) {
            ...
            $.each(buffer[gallery.pagination.currentPage], function() {
                $(this).addClass('current-page').css({
                    height: gallery.$container.data('height'),
                    width: gallery.$container.data('width')
                }).show(function() {
    ...
    Gallery.prototype.polaroidCaptionCalculate = (function($el) {
        ...
        if (figcaptionHeight) {
            ...
            $el.find('.gg-caption-row').css({
                'max-height': figcaptionHeight ? figcaptionHeight : '100%',
                'height': 'auto'
            });
    ...
    Gallery.prototype.changePopUpHash = function(hash) {
        ...
        if (changedUrlDisabled !== 'true') {
            ...
            var queryParams = this.updateQueryParams(window.location.search, {
                    '_gallery': hash
                }),
            ...
            if (!this.popupIsInit) {
                ...
                if (queryParams === document.location.search) {
                    ...
                    History.replaceState({
                        ...
                        hash: hash,
                        state: 'close'
                    }, document.title, window.location.pathname + this.updateQueryParams(window.location.search, {
                        '_gallery': null
                    }));
