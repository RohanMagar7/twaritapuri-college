...
! function($) {
    ...
    function Plugin(action, options) {
        ...
        return $container.length || ($container = $("body")), $container
        ...
        var that = this,
            ...
            getTarget = function() {
                ...
                return element.length || (element = that.getContainer().filter(selector)), element
            };
        ...
        $target.length && (id = $target.attr("id")), id && (history.pushState ? history.pushState(null, null, "#" + id) : location.hash = "#" + id)
